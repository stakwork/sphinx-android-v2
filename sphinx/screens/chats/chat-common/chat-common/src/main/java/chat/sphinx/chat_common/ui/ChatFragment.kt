...
/**
 * Pathological-input guard against runaway pastes. NOT a protocol/byte limit —
 * it carries no overhead arithmetic and applies identically to plain text,
 * captions, replies, and thread replies.
 */
        ...
        >(layoutId), ChatSideEffectFragment, SlideToCancelImageView.SlideToCancelListener
{
    ...
    private fun setupFooter(insetterActivity: InsetterActivity) {
        ...
        footerBinding.apply {
            ...
            // Pathological-input guard against runaway pastes — NOT a protocol/byte limit.
            // Carries no overhead arithmetic and applies identically to plain text,
            // captions, replies, and thread replies.
